...
test('visual-iPhone-scheduleSearch', async ({ page }) => {
...
test('visual-iPhone-selectSeat-guest', async ({ page }) => {
    const scheduleSearchPage = new ScheduleSearchPage(page);
...
test('visual-iPhone-selectSeat-accountCreate', async ({ page }) => {
    const scheduleSearchPage = new ScheduleSearchPage(page);
    const selectSeatPage = new SelectSeatPage(page);
...
test('visual-iPhone-reservationGuestLogin', async ({ page }) => {
...
test('visual-iPhone-login', async ({ page }) => {
...
test('visual-iPhone-accountCreate', async ({ page }) => {
...
test('visual-iPhone-accountUpdate', async ({ page, commonLogin, logout }) => {
...
test('visual-iPhone-passwordUpdate', async ({ page, commonLogin, logout }) => {
...
test('visual-iPhone-reservationList', async ({ page, commonLogin, logout }) => {
