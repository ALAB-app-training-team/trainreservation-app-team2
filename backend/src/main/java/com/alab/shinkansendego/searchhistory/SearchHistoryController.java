...
public class SearchHistoryController {
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<Void> deleteSearchHistory(@AuthenticationPrincipal AccountSessionDto session, @PathVariable UUID id) {
        searchHistoryService.deleteSearchHistory(id, session.getId());
