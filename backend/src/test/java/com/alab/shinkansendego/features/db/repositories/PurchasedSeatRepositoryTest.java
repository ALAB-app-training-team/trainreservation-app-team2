...
public class PurchasedSeatRepositoryTest {
    ...
    @Test
    @Sql(scripts = "classpath:com/alab/shinkansendego/db/sql/PurchasedSeatTestData_Reservation.sql")
    ...
    @Test
    @Sql(scripts = {"classpath:com/alab/shinkansendego/db/sql/PurchasedSeatRepositoryTestData_Schedule.sql"})
