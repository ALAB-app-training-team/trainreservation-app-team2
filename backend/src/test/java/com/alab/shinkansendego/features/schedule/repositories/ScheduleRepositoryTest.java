...
@Testcontainers
@Sql(scripts = {"classpath:com/alab/shinkansendego/features/schedule/sql/TrainTypeTestData.sql", "classpath:com/alab/shinkansendego/features/schedule/sql/ScheduleTestData.sql"})
